...
int mostrar_gasosa(int gasosa[]){

    wbr02(520, 10, 0, gasosa[4], 11);
    wbr02(540, 10, 0,gasosa[3] , 12);  
    wbr02(560, 10, 0, gasosa[2], 13);
    wbr02(580, 10, 0, gasosa[1],14);
    wbr02(600, 10, 0, gasosa[0], 15);
...
int main() {
  ...
  while(1){
    ...
    pos_x = 300;
    pos_y = 400;
    //cotrola o mostrador de gasolina
    int contador_gasolina = 5;
    int vet_gasolina[] = {1,1,1,1,1};
    ...
    while(vida && gasolina){
      ...
      if(tempo % 500 == 0){
        gasolina-=20;
        vet_gasolina[contador_gasolina] = 0;
        contador_gasolina -=1;
        printf("%d\n", gasolina); 
      }
      ...
      if((pos_x + 20 > pos_x_gasolina && pos_x +20 < pos_x_gasolina+ 20 ) || (pos_x > pos_x_gasolina && pos_x < pos_x_gasolina + 20)){
        if((pos_y >pos_y_gasolina && pos_y < pos_y_gasolina + 20)|| (pos_y +20 > pos_y_gasolina  && pos_y +20 < pos_y_gasolina+20)){
          if(gasolina < 100){
            gasolina+=20;
            contador_gasolina +=1;
            vet_gasolina[contador_gasolina]=1;
          }
          gasolina_criada = 0;
