...
int main() {
  ...
  while(1){
    ...
    // if((pos_x_tiro + 10 >= vetor_pos_x[1] && pos_x_tiro + 9 <= vetor_pos_x[1]+20) || 
    // (pos_x_tiro+9>=vetor_pos_x[1] && pos_x_tiro+10<=vetor_pos_x[1]+20)){
    //   if (pos_y_tiro <= vetor_pos_y[1] + 19 && pos_y_tiro >= vetor_pos_y[1]){
    //     vetor_pos_y[1] = 460;
    //     pos_y_tiro = 0;
    //   }
    // }
    // if((pos_x_tiro + 10 >= vetor_pos_x[2] && pos_x_tiro + 9 <= vetor_pos_x[2]+20) || 
    // (pos_x_tiro+9>=vetor_pos_x[2] && pos_x_tiro+10<=vetor_pos_x[2]+20)){
    //   if (pos_y_tiro <= vetor_pos_y[2] + 19 && pos_y_tiro >= vetor_pos_y[2]){
    //     vetor_pos_y[2] = 460;
    //     pos_y_tiro = 0;
    //   }
    // }
    // if((pos_x_tiro + 10 >= vetor_pos_x[3] && pos_x_tiro + 9 <= vetor_pos_x[3]+20) || 
    // (pos_x_tiro+9>=vetor_pos_x[3] && pos_x_tiro+10<=vetor_pos_x[3]+20)){
    //   if (pos_y_tiro <= vetor_pos_y[3] + 19 && pos_y_tiro >= vetor_pos_y[3]){
    //     vetor_pos_y[3] = 460;
    //     pos_y_tiro = 0;
    //   }
    // }
    ...
    //   if((pos_y >vetor_pos_y[0] && pos_y < vetor_pos_y[0] + 20)|| (pos_y +20 > vetor_pos_y[0]  && pos_y +20 < vetor_pos_y[0]+20)){
    //     wbr01(7, 0, 0);
    //   }
    // }
    ...
    //   if((pos_y >vetor_pos_y[1] && pos_y < vetor_pos_y[1] + 20)|| (pos_y +20 > vetor_pos_y[1]  && pos_y +20 < vetor_pos_y[1]+20)){
    //     wbr01(7, 0, 0);
    //   }
    // }
    ...
    //   if((pos_y >vetor_pos_y[2] && pos_y < vetor_pos_y[2] + 20)|| (pos_y +20 > vetor_pos_y[2]  && pos_y +20 < vetor_pos_y[2]+20)){
    //     wbr01(7, 0, 0);
    //   }
    // }
    ...
    //   if((pos_y >vetor_pos_y[3] && pos_y < vetor_pos_y[3] + 20)|| (pos_y +20 > vetor_pos_y[3]  && pos_y +20 < vetor_pos_y[3]+20)){
    //     wbr01(7, 0, 0);
    //   }
    // }
    ...
    //     pos_y < vetor_pos_y[0] + 20 &&
    //     pos_y + 1 > vetor_pos_y[0]) {
